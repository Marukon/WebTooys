...
var eggs = {
    ...
    103: '≧ ﹏ ≦',
    104: '100下是不是太少了（）',
    105: '写不动了，后面真的没了，除非你能点到一个及其大的数字',
    106: '再见~',
    110: '我是一个装饰按钮我是一个装饰按钮我是一个装饰按钮',
    520: '您已抵达：520下',
    530: '我是一个装饰按钮我是一个装饰按钮我是一个装饰按钮',
    721: '0721~',
    722: '我是一个装饰按钮我是一个装饰按钮我是一个装饰按钮',
    10086: '怎么点了10086下？',
    10087: '我是一个装饰按钮我是一个装饰按钮我是一个装饰按钮',
    114514: '114514+下了，嗯哼哼啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊啊',
    114520: '我是一个装饰按钮我是一个装饰按钮我是一个装饰按钮',
    33550336: '你是白厄吗？',
    33550337: '再次踏上轮回……',
        ...
        for(let i=0;i<categorized.no.length;i++){
            ...
            let card = $(`
                <mdui-card clickable href="${item.url}">
                    ...
                    <h1>${item.name}</h1>
                    <p>${item.desc}</p>
                    ${item.github ? `<mdui-chip href="${item.github}" icon="code" target="_blank">Source</mdui-chip>` : ''}
                </mdui-card>`);
